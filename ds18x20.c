...
*/
uint8_t
DS18X20_meas_to_cel (uint8_t fc, uint8_t * sp, uint8_t * subzero,
...
15	9375	375	*/
uint16_t
DS18X20_temp_to_decicel (uint8_t subzero, uint8_t cel, uint8_t cel_frac_bits)
{
  uint16_t h;
  uint8_t i;
...
uint8_t
DS18X20_start_meas (uint8_t with_power_extern, uint8_t id[])
{
  ow_reset ();                  //**
...
uint8_t
DS18X20_read_meas_single (uint8_t familycode, uint8_t * subzero,
                          uint8_t * cel, uint8_t * cel_frac_bits)
{
  uint8_t i;
